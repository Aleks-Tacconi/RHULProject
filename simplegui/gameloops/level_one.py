...
from entities import Block, Player, Attack, AbyssalRevenant, Fire, PlayerHealthBar, Background, ImpalerBoss
...
class LevelOne(GameLoop):
    def __init__(self, reset: Callable) -> None:
        ...
        self.__enemies.append(ImpalerBoss(pos=Vector(600, 500)))
